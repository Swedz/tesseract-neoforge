...
public class BlockHolder<BlockType extends Block> extends ModeledRegisteredObjectHolder<Block, BlockType, ModelProvider, BlockHolder<BlockType>>
{
	...
	public BlockHolder(Identifier location, String englishName,
