...
public class ItemHolder<Type extends Item> extends ModeledRegisteredObjectHolder<Item, Type, ModelProvider, ItemHolder<Type>> implements ItemLike
{
	private final ItemRegisterableWrapper<Type> registerableItem;
	
	private SortOrder sortOrder = SortOrder.UNSORTED;
	
	public ItemHolder(Identifier id, String englishName, DeferredRegister.Items registerItems, Function<Item.Properties, Type> creator)
	{
