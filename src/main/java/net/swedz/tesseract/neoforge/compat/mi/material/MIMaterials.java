...
public interface MIMaterials
{
	...
	Material IRON = Materials.IRON.as(MI.ID).clearRecipes()
			...
			.addNative(TANK.set(TANK_CAPACITY, 1L))
			.recipes(STANDARD, STANDARD_MACHINES, SMELTING, FORGE_HAMMER);
	...
	Material BRICK = MIMaterials.create("brick", "Brick")
			.set(HARDNESS, 2f)
	...
	Material FIRE_CLAY = MIMaterials.create("fire_clay", "Fire Clay")
			.set(HARDNESS, 2f)
			.set(NEEDS_TOOL, Optional.empty())
			.set(TIME_FACTOR, SOFT)
	...
	Material COKE = MIMaterials.create("coke", "Coke")
			.set(MAIN_PART, GEM)
			.set(TIME_FACTOR, SOFT)
			.addNative(GEM, DUST, BLOCK)
			.recipes(STANDARD, STANDARD_MACHINES, DUST_TO_GEM);
	
	Material BRONZE = MIMaterials.create("bronze", "Bronze")
			.set(TIME_FACTOR, SOFT)
			...
			.addNative(TANK.set(TANK_CAPACITY, 4L))
			.recipes(STANDARD, STANDARD_MACHINES, SMELTING, FORGE_HAMMER);
	
	Material TIN = MIMaterials.create("tin", "Tin")
			.set(TIME_FACTOR, SOFT)
			.addNative(BOLT, BLADE, RING, ROTOR, GEAR, ROD, CURVED_PLATE, DOUBLE_INGOT, DUST, INGOT, NUGGET, PLATE, TINY_DUST)
			.addNative(WIRE)
	...
	Material STEEL = MIMaterials.create("steel", "Steel")
			...
			.addNative(TANK.set(TANK_CAPACITY, 16L))
			.recipes(STANDARD, STANDARD_MACHINES, SMELTING, FORGE_HAMMER);
	
	Material LIGNITE_COAL = MIMaterials.create("lignite_coal", "Lignite Coal")
			.set(MAIN_PART, GEM)
			.set(TIME_FACTOR, SOFT)
	...
	Material ALUMINUM = MIMaterials.create("aluminum", "Aluminum")
			...
			.addNative(TANK.set(TANK_CAPACITY, 64L))
			.recipes(STANDARD, STANDARD_MACHINES, blastFurnace());
	
	Material BAUXITE = MIMaterials.create("bauxite", "Bauxite")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
	...
	Material LEAD = MIMaterials.create("lead", "Lead")
	...
	Material BATTERY_ALLOY = MIMaterials.create("battery_alloy", "Battery Alloy")
			.set(TIME_FACTOR, SOFT)
			.addNative(TINY_DUST, DUST, INGOT, DOUBLE_INGOT, PLATE, CURVED_PLATE, NUGGET)
			.addNative(BLOCK)
			.recipes(STANDARD, STANDARD_MACHINES, SMELTING);
	
	Material INVAR = MIMaterials.create("invar", "Invar")
	...
	Material CUPRONICKEL = MIMaterials.create("cupronickel", "Cupronickel")
			.set(TIME_FACTOR, SOFT)
	...
	Material ANTIMONY = MIMaterials.create("antimony", "Antimony")
			.set(TIME_FACTOR, SOFT)
	...
	Material NICKEL = MIMaterials.create("nickel", "Nickel")
			.addNative(DOUBLE_INGOT, DUST, INGOT, NUGGET, PLATE, TINY_DUST)
			.addNative(RAW_METAL, RAW_METAL_BLOCK)
			.addNative(BLOCK)
			.addNative(ORE, ORE_DEEPSLATE)
	...
	Material SILVER = MIMaterials.create("silver", "Silver")
			.set(TIME_FACTOR, SOFT)
			.addNative(DOUBLE_INGOT, DUST, INGOT, NUGGET, PLATE, TINY_DUST)
			.addNative(WIRE)
			.addNative(RAW_METAL, RAW_METAL_BLOCK)
	...
	Material SODIUM = MIMaterials.create("sodium", "Sodium")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
	...
	Material SALT = MIMaterials.create("salt", "Salt")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
	...
	Material TITANIUM = MIMaterials.create("titanium", "Titanium")
			...
			.addNative(TANK.set(TANK_CAPACITY, 1024L))
			.recipes(STANDARD, STANDARD_MACHINES.without("raw_metal_to_dust"), blastFurnace(true, 128, 400));
	
	Material ELECTRUM = MIMaterials.create("electrum", "Electrum")
			.set(TIME_FACTOR, SOFT)
			.addNative(DOUBLE_INGOT, DUST, INGOT, NUGGET, PLATE, TINY_DUST)
			.addNative(BLOCK)
			.addNative(WIRE, FINE_WIRE)
	...
	Material SILICON = MIMaterials.create("silicon", "Silicon")
			.set(TIME_FACTOR, SOFT)
	...
	Material STAINLESS_STEEL = MIMaterials.create("stainless_steel", "Stainless Steel")
			.set(TIME_FACTOR, HARD)
			.addNative(BOLT, BLADE, RING, ROTOR, GEAR, ROD, CURVED_PLATE, DOUBLE_INGOT, DUST, INGOT, LARGE_PLATE, NUGGET, PLATE, TINY_DUST)
			.addNative(BLOCK)
			.addNative(HOT_INGOT)
			...
			.addNative(TANK.set(TANK_CAPACITY, 256L))
			.recipes(STANDARD, STANDARD_MACHINES.without("rod_to_magnetic"), blastFurnace(true, 32, 400));
	
	Material RUBY = MIMaterials.create("ruby", "Ruby")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, HARD)
			.addNative(DUST, TINY_DUST)
			.recipes(STANDARD, STANDARD_MACHINES);
	
	Material CARBON = MIMaterials.create("carbon", "Carbon")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
			.addNative(DUST, TINY_DUST)
			.addNative(PLATE, LARGE_PLATE)
	...
	Material CHROMIUM = MIMaterials.create("chromium", "Chromium")
			.addNative(ITEM_PURE_METAL)
			.addNative(HOT_INGOT)
	...
	Material MANGANESE = MIMaterials.create("manganese", "Manganese")
			.set(MAIN_PART, DUST)
			.addNative(ITEM_PURE_NON_METAL)
			.recipes(STANDARD, STANDARD_MACHINES.without("crushed_dust_to_dust"));
	
	Material BERYLLIUM = MIMaterials.create("beryllium", "Beryllium")
			.set(TIME_FACTOR, HARD)
			.addNative(DOUBLE_INGOT, DUST, INGOT, NUGGET, PLATE, TINY_DUST)
			.addNative(BLOCK)
			.recipes(STANDARD, STANDARD_MACHINES);
	
	Material ANNEALED_COPPER = MIMaterials.create("annealed_copper", "Annealed Copper")
			.set(TIME_FACTOR, SOFT)
			.addNative(ITEM_PURE_METAL)
	...
	Material URANIUM_235 = MIMaterials.create("uranium_235", "Uranium 235")
			.set(TIME_FACTOR, VERY_HARD)
	...
	Material URANIUM_238 = MIMaterials.create("uranium_238", "Uranium 238")
			.set(TIME_FACTOR, SOFT)
	...
	Material URANIUM = MIMaterials.create("uranium", "Uranium")
	...
	Material LE_URANIUM = MIMaterials.create("le_uranium", "LE Uranium")
			.set(TIME_FACTOR, VERY_HARD)
	...
	Material HE_URANIUM = MIMaterials.create("he_uranium", "HE Uranium")
			.set(TIME_FACTOR, VERY_HARD)
	...
	Material PLUTONIUM = MIMaterials.create("plutonium", "Plutonium")
			.set(TIME_FACTOR, VERY_HARD)
	...
	Material LE_MOX = MIMaterials.create("le_mox", "LE Mox")
			.set(TIME_FACTOR, VERY_HARD)
	...
	Material HE_MOX = MIMaterials.create("he_mox", "HE Mox")
			.set(TIME_FACTOR, VERY_HARD)
	...
	Material PLATINUM = MIMaterials.create("platinum", "Platinum")
			.addNative(ITEM_PURE_METAL)
	...
	Material KANTHAL = MIMaterials.create("kanthal", "Kanthal")
			.set(TIME_FACTOR, HARD)
	...
	Material IRIDIUM = MIMaterials.create("iridium", "Iridium")
			.set(TIME_FACTOR, VERY_HARD)
			.addNative(ITEM_PURE_METAL)
	...
	Material MONAZITE = MIMaterials.create("monazite", "Monazite")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
			.set(ORE_DROP_PART, OrePartDrops.experience(DUST, UniformInt.of(1, 4)))
			.addNative(ITEM_PURE_NON_METAL)
	...
	Material CADMIUM = MIMaterials.create("cadmium", "Cadmium")
			.set(TIME_FACTOR, SOFT)
	...
	Material NEODYMIUM = MIMaterials.create("neodymium", "Neodymium")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
			.addNative(DUST, TINY_DUST)
			.addNative(BLOCK)
	...
	Material YTTRIUM = MIMaterials.create("yttrium", "Yttrium")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
			.addNative(DUST, TINY_DUST)
			.addNative(BLOCK)
	...
	Material SUPERCONDUCTOR = MIMaterials.create("superconductor", "Superconductor")
			.set(TIME_FACTOR, HARD)
			.addNative(TINY_DUST, DUST, PLATE, INGOT, NUGGET, WIRE, DOUBLE_INGOT, HOT_INGOT)
			.addNative(COIL)
	...
	Material TUNGSTEN = MIMaterials.create("tungsten", "Tungsten")
			.set(TIME_FACTOR, VERY_HARD)
			.addNative(ITEM_PURE_METAL)
	...
	Material BLASTPROOF_ALLOY = MIMaterials.create("blastproof_alloy", "Blastproof Alloy")
			.set(TIME_FACTOR, VERY_HARD)
	...
	Material NUCLEAR_ALLOY = MIMaterials.create("nuclear_alloy", "Nuclear Alloy")
			.set(TIME_FACTOR, VERY_HARD)
			.addNative(PLATE, LARGE_PLATE)
			.addNative(MACHINE_CASING_PIPE.set(BLAST_RESISTANCE, 6000f))
	...
	Material SOLDERING_ALLOY = MIMaterials.create("soldering_alloy", "Soldering Alloy")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
			.addNative(DUST, TINY_DUST)
			.addNative(BLOCK)
	...
	Material SULFUR = MIMaterials.create("sulfur", "Sulfur")
			.set(MAIN_PART, DUST)
			.set(TIME_FACTOR, SOFT)
			.addNative(DUST, TINY_DUST)
			.addNative(BLOCK)
