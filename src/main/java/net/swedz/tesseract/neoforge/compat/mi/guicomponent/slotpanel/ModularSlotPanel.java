...
public final class ModularSlotPanel implements GuiComponentServer<ModularSlotPanel.Params, ModularSlotPanel.Data>
{
	...
	private static final Map<Identifier, Slot> SLOTS = Maps.newHashMap();
	
	public static final Identifier REDSTONE_MODULE  = registerMISlot("redstone_module", SlotPanel.SlotType.REDSTONE_MODULE);
	public static final Identifier UPGRADES         = registerMISlot("upgrades", SlotPanel.SlotType.UPGRADES);
	public static final Identifier CASINGS          = registerMISlot("casings", SlotPanel.SlotType.CASINGS);
	public static final Identifier OVERDRIVE_MODULE = registerMISlot("overdrive_module", SlotPanel.SlotType.OVERDRIVE_MODULE);
	
	public static Identifier registerSlot(Identifier id, SlotGroup group,
										  int stackLimit, Predicate<ItemStack> insertionChecker,
										  Identifier atlas, int u, int v,
	...
	private static Identifier registerMISlot(String name, SlotPanel.SlotType slotType)
	{
	...
	static Slot getSlot(Identifier id)
	{
	...
	public ModularSlotPanel with(Identifier slotId, Supplier<Integer> stackLimit, SimpleItemStackComponent component)
	{
	...
	public ModularSlotPanel with(Identifier slotId, SimpleItemStackComponent component)
	{
	...
	public void setupMenu(GuiComponent.MenuFacade menu)
	{
		for(int i = 0; i < slots.size(); i++)
		{
			...
			menu.addSlotToMenu(
					new HackySlot(getSlotX(machine.guiParams), getSlotY(i))
					{
						@Override
	...
	{
		public static final StreamCodec<ByteBuf, Slot> STREAM_CODEC = Identifier.STREAM_CODEC
