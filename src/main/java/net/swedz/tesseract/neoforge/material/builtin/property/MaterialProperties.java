...
public interface MaterialProperties
{
	...
	MaterialProperty<MaterialPartItemReferenceFormatter> ITEM_REFERENCE = create("item_reference", (namespace, material, part) -> Identifier.fromNamespaceAndPath(namespace, part.formatId(material)).toString());
	...
	MaterialProperty<Integer> TOOL_DURABILITY = create("tool_durability", 0);
	
	MaterialProperty<Integer> TOOL_ENCHANTABILITY = create("tool_enchantability", 0);
