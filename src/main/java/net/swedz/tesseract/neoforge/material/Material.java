...
public final class Material implements MaterialPropertyHolder.Mutable, MaterialPartHolder.Mutable
{
	...
	public Material(Identifier id, String englishName)
	{
		this.id = id;
	...
	{
		return this.copy((id, name) -> new Material(Identifier.fromNamespaceAndPath(namespace, id.getPath()), name));
	}
	...
	{
		Identifier id = Identifier.fromNamespaceAndPath(modId, part.formatId(this));
