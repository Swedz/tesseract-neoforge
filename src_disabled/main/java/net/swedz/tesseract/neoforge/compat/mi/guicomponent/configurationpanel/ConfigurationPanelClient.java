...
/**
 * This was stolen from {@link aztech.modern_industrialization.client.machines.guicomponents.ShapeSelectionClient} to
 * make my own generic "configuration panel" component to be used for non-shape related configuring of machines.
 */
public final class ConfigurationPanelClient extends GuiComponentClient<ConfigurationPanel.Params, ConfigurationPanel.Data>
{
	...
	final class Renderer implements ClientComponentRenderer
	{
		...
		public void renderBackground(GuiGraphics graphics, int leftPos, int topPos)
		{
			...
			graphics.blit(MachineScreen.BACKGROUND, box.x(), box.y(), 0, 0, box.w(), box.h() - 4, 256, 256);
			graphics.blit(MachineScreen.BACKGROUND, box.x(), box.y() + box.h() - 4, 0, 252, box.w(), 4, 256, 256);
