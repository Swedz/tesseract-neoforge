...
{
	public MIMachineMaterialRecipeContext(MaterialRegistry registry, Material material, HolderLookup.Provider registries, RecipeOutput recipes)
	{
	...
	{
		MIMachineRecipeBuilder recipe = new MIMachineRecipeBuilder(registries, type, eu, duration)
	...
	{
		return this.machine(id, CUTTING_MACHINE, input, inputCount, output, outputCount, (b) -> b.fluidIn(MIFluids.LUBRICANT, 1));
	}
