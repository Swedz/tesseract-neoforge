...
public final class SpecialMachineBuilder extends MachineWithGuiBuilder<SpecialMachineBuilder>
{
	...
	{
		return super.builtinModel(
				casing, overlayFolder, (b) ->
				{
	...
	public SpecialMachineBuilder registerExtraWorkstations(Identifier... workstations)
	{
	...
	public SpecialMachineBuilder registerAsWorkstationFor(Identifier otherMachineId)
	{
